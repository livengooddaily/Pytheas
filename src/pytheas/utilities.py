...
null_equivalent_values = ['', 'data not available', 'nan', 'not available', 'no data', 'no answer', 'nd', 'na', 'n/d',
                          'n/a', 'n.a.', 'not applicable', 'sans objet', 's.o.', 'so', 's/o', '-', '--', '.', '..',
                          '...', 'null', 'none', '*', 'void', '0']
...
class DataTable:
    def __init__(self, premeta, header, data, postmeta, deciding_row, first_disagreeing_row, sorted_row_confidences,
